...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps.Join(emps, emp1 => emp1.EmpNo, emp2 => emp2.Mgr, (emp1, emp2) => new { Employee = emp1.EName, Manager = emp2.EName }).ToList();
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.SelectMany(e=>
                    depts.Where(d => d.DeptNo == e.DeptNo), (e, d) => new { e, d }).SelectMany(ed =>
